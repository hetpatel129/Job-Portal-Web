      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="relative px-8">
          <Carousel className="w-full">
            ...
            <CarouselPrevious className="left-0 dark:bg-gray-800 dark:border-gray-700 dark:text-white dark:hover:bg-gray-700" />
            <CarouselNext className="right-0 dark:bg-gray-800 dark:border-gray-700 dark:text-white dark:hover:bg-gray-700" />
          </Carousel>
        </div>
      </div>
    </div>
